...
# Time-stamp: <2021-03-08 22:40:36 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2021-03-08 Mo 22:40]
   | Headline                         | Time       |          |          |         |       |      |
   |----------------------------------+------------+----------+----------+---------+-------+------|
   | *Total time*                     | *6d 23:17* |          |          |         |       |      |
   |----------------------------------+------------+----------+----------+---------+-------+------|
   ...
   | \_  Main                         |            |     0:56 |          |         |       |      |
   | \_    Shutdown                   |            |          |     0:56 |         |       |      |
   | \_  Components [16/25]           |            | 6d 22:21 |          |         |       |      |
   | \_    Feed [5/6]                 |            |          |  1d 6:52 |         |       |      |
   | \_      Homepage                 |            |          |          |    0:12 |       |      |
   | \_      Rating [2/3]             |            |          |          | 1d 3:24 |       |      |
   ...
   | \_    Web interface [3/7]        |            |          | 1d 14:11 |         |       |      |
   | \_      Embed                    |            |          |          |    3:00 |       |      |
   | \_      Snazzy [2/3]             |            |          |          |    4:04 |       |      |
   | \_        Ooopsie [1/1]          |            |          |          |         |  0:51 |      |
   | \_          Read later form      |            |          |          |         |       | 0:51 |
   | \_        Subscribe              |            |          |          |         |  2:35 |      |
   | \_      Limit description length |            |          |          |    0:26 |       |      |
   | \_      Manage Feeds             |            |          |          |   11:46 |       |      |
   | \_    Tags [2/4]                 |            |          |  1d 9:59 |         |       |      |
   | \_      Database                 |            |          |          |   10:59 |       |      |
   | \_        Hierarchy              |            |          |          |         |  8:58 |      |
   | \_      Web interface            |            |          |          |   21:10 |       |      |
   | \_    Search [2/3]               |            |          |     3:30 |         |       |      |
...
**** TODO [#E] Un-escape HTML?
     ...
     actually.
**** TODO [#D] Limit description length
     :LOGBOOK:
